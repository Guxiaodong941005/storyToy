...
//播放信息模型
@interface RBPlayInfoModel : NSObject
...
@property(nonatomic,strong) NSArray<RBResourceModel*> *resources;//资源数组
@property(nonatomic,strong) NSArray<RBAlbumModel*> *albums;// 专辑数组
