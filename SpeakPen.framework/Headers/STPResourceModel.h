...
//播放信息模型
@interface STPPlayInfoModel : NSObject
...
@property(nonatomic,assign) BOOL fav_able;
@property(nonatomic,assign) NSInteger battery;//电量
@end

//专辑
@interface STPAlbumModel : NSObject
@property(nonatomic,strong) NSString *aID;// 专辑ID
...
//第二级 专辑列表
@interface STPAlbumList : NSObject
@property(nonatomic,assign) NSInteger total;// 分类下的专辑的总数量
@property(nonatomic,strong) NSArray<STPAlbumModel*> *albums;
@end

// 资源分类
@interface STPCategoryModel : NSObject
...
@property(nonatomic,strong) NSArray<STPAlbumModel*> *albums; // 分类推荐的四个专辑
@end

//第一级分类列表
@interface STPCategoryList : NSObject
@property(nonatomic,assign) NSInteger total;// 分类的总数量
@property(nonatomic,strong) NSArray<STPCategoryModel*> *categories;// 资源分类列表
@end

// 播放资源
@interface STPResourceModel : NSObject
...
@property(nonatomic,strong) NSString *pic;//专辑图片
@property(nonatomic,strong) NSString *fid;//收藏的资源ID 注意：0 表示当前资源未被收藏
@end

//第三级资源列表
@interface STPResourceList : NSObject
@property(nonatomic,strong) NSString *aID;//专辑ID
...
@property(nonatomic,strong) NSString *des;//专辑描述
@property(nonatomic,strong) NSArray<STPResourceModel*> *list;
@end

// 收藏模型
@interface STPCollectionModel : NSObject
...
// 收藏列表
@interface STPCollectionList : NSObject
@property(nonatomic,assign) NSInteger count;//总数量
@property(nonatomic,strong) NSArray<STPCollectionModel*> *list;
@end

//播放历史记录
@interface STPResHistoryModel : NSObject
@property(nonatomic,strong) NSString *hID;//历史ID
@property(nonatomic,assign) NSInteger favorite_id;//收藏ID
@property(nonatomic,strong) NSString *act;//专辑类别
@property(nonatomic,strong) NSString *rID;//资源ID
@property(nonatomic,strong) NSString *name;//专辑类别
...
//播放历史列表
@interface STPResHistoryList : NSObject
@property(nonatomic,assign) BOOL is_more;// 是否存在下一页
@property(nonatomic,strong) NSArray<STPResHistoryModel*>*list;
@end

//搜索列表
@interface STPSearchResultList : NSObject
@property(nonatomic,assign) NSInteger resourcesTotal;// 资源总数
@property(nonatomic,assign) NSInteger albumsTotal;// 专辑总数
@property(nonatomic,strong) NSArray<STPResourceModel*> *resources;//资源数组
@property(nonatomic,strong) NSArray<STPAlbumModel*> *albums;// 专辑数组
